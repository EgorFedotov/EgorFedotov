...
Мне 26 лет, я backend разработчик. Пишу backend, Реализовал несколько проектов на Django и FastAPI, написал пару телеграмм ботов и парсеров, читаю книги: Чистый код, Грокаем алгоритмы, продолжаю изучать новые технологии.
